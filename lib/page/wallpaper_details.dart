...
class WallpaperDetails extends GetView<HomeController> {
  ...
  WallpaperDetails() {
    loadAds();
    controller.checkFavorite(controller.selected.value,1);
            ...
            child: SizedBox(
              ...
              child: PageView.builder(
                // pageSnapping: true,
                  ...
                  itemCount: controller.arrOfWallpaper.length,
                  onPageChanged: (index) {
                    controller.selected.value = index;
                    controller.checkFavorite(index,1);
                  },
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:  controller.arrOfWallpaper[index]
                                      .image,
                                  height: 60,
                                  width: 55,
                                  fit: BoxFit.cover,
                  ...
                  onPressed: () async {
                    if (!controller.isFavorite.value) {
                      int id = await controller.sqliteService
                          .addToFavorite(controller.arrOfWallpaper[
                      controller.selected.value]);
                      controller
                          .checkFavorite(controller.selected.value,1);
                    } else {
