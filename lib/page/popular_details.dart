...
class PopularDetails extends GetView<HomeController> {
  ...
  PopularDetails() {
    loadAds();
    controller.checkFavorite(controller.selected.value,2);
              ...
              children: [
                PinchZoom(
                  ...
                  child:  CachedNetworkImage(
                    imageUrl: controller
                        .arrOfPopular[controller.selected.value].image,
                    fit: BoxFit.cover,
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:  controller.arrOfPopular[index]
                                      .image,
                                  height: 60,
                                  width: 55,
                                  fit: BoxFit.cover,
                  ...
                  onPressed: () async {
                    if (!controller.isFavorite.value) {
                      int id = await controller.sqliteService
                          .addToFavorite(controller.arrOfPopular[
                      controller.selected.value]);
                      controller
                          .checkFavorite(controller.selected.value,2);
                    } else {
